...
def update():
	...
	print('gpu')
	print(getTemperature(getPeripheral(getSensorList(), PERIPHERAL_GPU_NAME), TYPE_CORE)[0] + '°C')
	print('cpu')
	print(getTemperature(getPeripheral(getSensorList(), PERIPHERAL_CPU_NAME), TYPE_CORE))
...
def getPeripheral(sensors, peripheralName):
	if (peripheralName == PERIPHERAL_GPU_NAME or peripheralName == PERIPHERAL_CPU_NAME):
		return getSpcecifiedPeripheral(sensors, peripheralName);
	return 'No peripheral named "' + peripheralName + '" found.'

# Return GPU related informationsé
def getSpcecifiedPeripheral(sensors, peripheralName):
	peripheral = []
...
def update():
	...
	print(getTemperature(getPeripheral(getSensorList(), PERIPHERAL_GPU_NAME), TYPE_CORE)[0] + '°C')
	print('cpu')
	print(getTemperature(getPeripheral(getSensorList(), PERIPHERAL_CPU_NAME), TYPE_CORE)[0] + '°C')
